/**
 * Kneeboard glass - SimGlass v2.0.0
 * Combined notes, frequencies, timer, and reference
 */

class KneeboardGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.kneeboardGlass = new KneeboardGlass();
    window.addEventListener('beforeunload', () => window.kneeboardGlass?.destroy());
});
