 ...
 *
 * Dynamic fuel management glass for SimGlass Engine
...
class FuelGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.fuelGlass = new FuelGlass();
    window.addEventListener('beforeunload', () => window.fuelGlass?.destroy());
});
