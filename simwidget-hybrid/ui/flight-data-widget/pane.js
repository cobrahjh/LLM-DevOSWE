/**
 * SimGlass Flight Data pane v2.0.0
...
class FlightDataPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.FlightDataPane = new FlightDataPane();
    window.addEventListener('beforeunload', () => window.FlightDataPane?.destroy());
});
