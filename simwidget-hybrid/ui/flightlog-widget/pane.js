/**
 * Flight Log pane - SimGlass
 * Auto-logs flights with stats and totals
 */

class FlightLogPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.FlightLogPane = new FlightLogPane();
    window.addEventListener('beforeunload', () => window.FlightLogPane?.destroy());
});
