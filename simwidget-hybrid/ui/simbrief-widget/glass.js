...
class SimBriefGlass extends SimGlassBase {
    ...
    async sendToFlightPlan() {
        ...
        try {
            ...
            // Also broadcast route update for map glass
            syncChannel.postMessage({
                type: 'route-update',
                data: {
...
document.addEventListener('DOMContentLoaded', () => {
    window.simbriefGlass = new SimBriefGlass();
    window.addEventListener('beforeunload', () => window.simbriefGlass?.destroy());
});
