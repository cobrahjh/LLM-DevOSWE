...
class NotepadGlass extends SimGlassBase {
    constructor() {
        super({
    ...
    initSyncListener() {
        ...
        this.syncChannel.onmessage = (event) => {
            ...
            switch (type) {
                case 'copy-route':
                    // Received route from flight plan glass
...
document.addEventListener('DOMContentLoaded', () => {
    window.notepadGlass = new NotepadGlass();
    window.addEventListener('beforeunload', () => window.notepadGlass?.destroy());
});
