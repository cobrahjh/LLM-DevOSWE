...
class TinyWidgetsContainer extends SimGlassBase {
    constructor() {
        ...
        this.widgetStates = {};
        this.manifest = null;
        this.grid = document.getElementById('glass-container');
...
document.addEventListener('DOMContentLoaded', () => {
    window.tinyGlasss = new TinyWidgetsContainer();
    // SimGlassBase provides destroy() - wire to beforeunload
    window.addEventListener('beforeunload', () => window.tinyGlasss?.destroy());
});
