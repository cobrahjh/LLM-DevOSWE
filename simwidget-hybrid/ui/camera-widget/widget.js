/**
 * Camera Widget JavaScript v2.0.0
...
class CameraWidget extends SimGlassBase {
    constructor() {
        super({
            widgetName: 'camera-widget',
            widgetVersion: '2.0.0',
    ...
    initPlatformIndicator() {
        ...
        platformSection.innerHTML = `
            ...
            <div class="platform-indicator" id="platformIndicator">
                ...
                <button class="platform-refresh" onclick="window.cameraWidget.refreshPlatform()" title="Refresh platform detection">🔄</button>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('beforeunload', () => window.cameraWidget?.destroy());
});
