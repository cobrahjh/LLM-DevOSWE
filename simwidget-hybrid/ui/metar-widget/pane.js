/**
 * METAR pane - SimGlass v2.0.0
 * Real-time aviation weather from aviationweather.gov
 */

class MetarPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.MetarPane = new MetarPane();
    window.addEventListener('beforeunload', () => window.MetarPane?.destroy());
});
