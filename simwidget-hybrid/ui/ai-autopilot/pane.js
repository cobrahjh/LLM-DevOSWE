...
class AiAutopilotPane extends SimGlassBase {
    ...
    async _loadPhaseModule(phase) {
        ...
        const moduleFiles = {
            ground: 'modules/rule-engine-ground.js?v=5',
            takeoff: 'modules/rule-engine-takeoff.js?v=5',
            cruise: 'modules/rule-engine-cruise.js?v=5',
            approach: 'modules/rule-engine-approach.js?v=5'
        };
...
<div class="dbg-log" id="pw-log"></div>
    ...
    async _pollNearestAirport() {
        ...
        try {
            ...
            // Pick closest airport with hysteresis to prevent constant switching
            ...
            if (this._nearestAirport) {
                ...
                // If current airport not in range anymore, switch to closest
            }
