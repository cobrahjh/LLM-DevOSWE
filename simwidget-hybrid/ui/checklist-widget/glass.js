...
class ChecklistGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.checklistGlass = new ChecklistGlass();
    window.checklistGlass.initVoiceControl();
    window.addEventListener('beforeunload', () => window.checklistGlass?.destroy());
});
