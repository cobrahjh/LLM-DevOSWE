/**
 * Timer pane - SimGlass v2.0.0
 * Stopwatch and countdown timer for flight procedures
 */

class TimerPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.TimerPane = new TimerPane();
    window.addEventListener('beforeunload', () => window.TimerPane?.destroy());
});
