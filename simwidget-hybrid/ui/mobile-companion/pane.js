/**
 * Mobile Companion pane
 * Remote control + flight data viewer for phone/tablet
 */
class MobileCompanionPane extends SimGlassBase {
    constructor() {
        super({
    ...
    initEvents() {
        ...
        document.querySelectorAll('.pane-tab').forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                this.iframe.src = '/ui/' + tab.dataset.pane + '-glass/';
            });
        });
...
document.addEventListener('DOMContentLoaded', () => {
    window.mobileCompanion = new MobileCompanionPane();
