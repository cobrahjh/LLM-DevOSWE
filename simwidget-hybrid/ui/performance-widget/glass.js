/**
 * Performance glass - SimGlass
 * Displays FPS, GPU, CPU usage and frame timing
 */

class PerformanceGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.performanceGlass = new PerformanceGlass();
    window.addEventListener('beforeunload', () => window.performanceGlass?.destroy());
});
