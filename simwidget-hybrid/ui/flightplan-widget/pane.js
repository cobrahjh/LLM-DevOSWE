 ...
 * - Broadcasts copy-route for Notepad pane
 *
 * Voice Features:
...
class FlightPlanPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.FlightPlanPane = new FlightPlanPane();
    window.addEventListener('beforeunload', () => window.FlightPlanPane?.destroy());
});
