...
class WeatherPane extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.WeatherPane = new WeatherPane();
    window.addEventListener('beforeunload', () => window.WeatherPane?.destroy());
});
