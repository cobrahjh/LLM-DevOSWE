/**
 * Multiplayer glass - SimGlass
 * Shows nearby VATSIM/IVAO/MSFS multiplayer traffic
 */

class MultiplayerGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.multiplayerGlass = new MultiplayerGlass();
    window.addEventListener('beforeunload', () => window.multiplayerGlass?.destroy());
});
