/**
 * Landing Rate glass - SimGlass
 * Tracks touchdown vertical speed and grades landings
 */

class LandingGlass extends SimGlassBase {
    constructor() {
        super({
...
document.addEventListener('DOMContentLoaded', () => {
    window.landingGlass = new LandingGlass();
    // SimGlassBase provides destroy() - wire to beforeunload
    window.addEventListener('beforeunload', () => window.landingGlass?.destroy());
});
