...
class VoiceControlPane extends SimGlassBase {
    constructor() {
        super({
    ...
    async executeChecklist(cmd) {
        ...
        // Use BroadcastChannel API for cross-pane communication
...
document.addEventListener('DOMContentLoaded', () => {
    window.voiceControl = new VoiceControlPane();
