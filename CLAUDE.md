...
8. **Use mclaude** - all scripts/batch files must use `mclaude` (C:\LLM-DevOSWE\mclaude.bat), never `claude` directly. mclaude includes --dangerously-skip-permissions
...
| Use mclaude | Includes --dangerously-skip-permissions |
