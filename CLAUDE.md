...
8. **Use claude directly** - use `claude` for all CLI invocations. Add `--dangerously-skip-permissions` when needed for scripts/automation
...
| Use claude directly | Add --dangerously-skip-permissions for automation |
